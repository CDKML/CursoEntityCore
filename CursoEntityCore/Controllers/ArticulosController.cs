...
namespace CursoEntityCore.Controllers
{
    public class ArticulosController : Controller
    {
        ...
        public IActionResult AdministrarEtiquetas(int id)
        {
            ...
            List<int> listaTemporalEtiquetasArticulo = articuloEtiquetas.ListaArticuloEtiquetas.Select(e => e.Etiqueta_Id)
                .ToList();

            //Obtener todas las etiquetas cuyos IDs no estén en la listaTemporalEtiquetasArticulo
            ...
            //Crear lista de etiqueta para el dropdown
